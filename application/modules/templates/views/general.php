...
<html>
    <head>
        ...
        <link rel="stylesheet" href="localhost/normalize.css" type="text/css"/>

        <title>Confessions.fm</title>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <script type="text/javascript" language="javascript" src="localhost/jquery.js"></script>
        <link type="text/css" rel="stylesheet" href="localhost/style.css" />
        <script type="application/javascript" src="localhost/lib/fastclick.js"></script> 
...
<input type="checkbox" name="handler-left" class="handler" id="handler-left" onclick="null" />
   ...
   <ul>
	...
	<script src='localhost/ftscroller.js'></script>
